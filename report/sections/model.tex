...
originally introduced for image segmentation tasks in 2015. In general, CNNs with skip connections have been
...
is a relatively simple model family, allowing us to focus on
the specifics of our problem rather than the intricacies of the model. Second,
despite its simplicity, similar models such as CNNs with residual connections have been shown to be effective for image-to-image translation, such as \cite{dslr-quality}. Finally,
