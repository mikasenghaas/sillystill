...
To edit the loss functions or other parameters, you can edit the configuration files in \texttt{configs/experiment/single-image.yaml}. The model will be trained, and inference will be run automatically, with results logged locally. If you want to log to weights and biases, you can remove the logger flag.
