...
To aided our model's ability to learn noise patterns, we seed our models with an extra random noise channel. We vary the distribution from which the random seed noise is drawn using \textcolor{red}{Gaussian and uniform samples}.
