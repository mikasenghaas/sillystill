...
% Dataset collection
\textbf{Data Collection. }\label{subsubsec:data-collection} The main goal of the data collection was to capture an aligned and diverse dataset of digital-film image pairs: aligned, as our model should merely transfer style and not move content around, and diverse in order to capture Cinestill-800T's baheviour in a variety of scenes and lighting conditions.
