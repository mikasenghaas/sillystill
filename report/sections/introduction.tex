...
effects of the Cinestill-800T, an iconic film stock, known for its grain
textures, colour hues and red halation.
...
Most available solutions~\cite{film-grain-rendering} involve directly modelling
the physical processes that lead to the visual effects. However, the complex
...
models are often computationally expensive and slow, especially when applied to
...
tasks. Thus, one can hope that a deep learning model could learn higher-quality
style translations than existing methods, while being faster and more efficient.
...
camera raw-to-raw mappings, quality enhancement, greyscale colorisation, and
style transfer. As none have been directly applied to the problem of film
effect, we examined the techniques employed and how they could be
efficiently adapted to our task.
...
All this motivates our work, where we investigate the feasibility of using a
deep learning to recreate the visual effects of Cinestill-800T film in digital
images. We propose training a U-Net-like image style translation network on a
self-collected dataset of paired digital and film images. While we acknowledge
...
\begin{itemize}
    ...
    \item We investigate and analyse various techniques that help to improve the creation of visual effects, such as adding noise to the input, training on random-resized crops, or varying loss functions.
\end{itemize}