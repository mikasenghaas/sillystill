...
\institute{Supervised by Raphaël in CS413 at EPFL}
...
\input{sections/dataset.tex} % data collection and preprocessing
\input{sections/model.tex} % model architecture, losses, and training
\input{sections/results.tex} % eval metrics, results
